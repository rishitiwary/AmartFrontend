...
import classes from "./BlockDailyOffer.module.css"
...
export default class BlockDailyOffer extends Component {
                    ...
                    <Slider ref={c => (this.slider = c)} {...settings} >
                        <div className={classes.item}>
                            <div className={classes.categoryItem}>
                                <Link >
                                    <img className={classes.categoryImg} src="https://f.nooncdn.com/cms/pages/20220905/d2cc5aec79335baabcd7a0727e7ca10c/en_mb_uae-deals-01.png" alt="grocery-stamples" />
                        ...
                        <div className={classes.item}>
                            <div className={classes.categoryItem}>
                                <Link >
                                    <img className={classes.categoryImg} src="https://f.nooncdn.com/cms/pages/20220905/d2cc5aec79335baabcd7a0727e7ca10c/en_mb_uae-deals-02.png" alt="personalcare" />
                                    {/* <h6>Personal Care</h6> */}
                                </Link>
                            </div>
                        </div>
                        <div className={classes.item}>
                            <div className={classes.categoryItem}>
                                <Link >
                                    <img className={classes.categoryImg} src="https://f.nooncdn.com/cms/pages/20220905/d2cc5aec79335baabcd7a0727e7ca10c/en_mb_uae-deals-03.png" alt="household-imtes" />
                        ...
                        <div className={classes.item}>
                            <div className={classes.categoryItem}>
                                ...
                                // }}
                                >
                                    <img className={classes.categoryImg} src="https://f.nooncdn.com/cms/pages/20220905/d2cc5aec79335baabcd7a0727e7ca10c/en_mb_uae-deals-04.png" alt="kitchen" />
                                    {/* <h6>Home &amp; Kitchen</h6> */}
                                </Link>
                            </div>
                        </div>
