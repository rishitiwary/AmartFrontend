...
import "./BlockProductsThreeSquare.css";
...
function BlockProductsThreeSquare(props) {
        ...
        <div className="product-catagory-wrap">
          <div className="row mb-4 p-3">
            {categories && categories.length
              ? categories?.splice(0, 3).map((row, index) => (
                  <div className="col-4 mt-1 p-0" key={index}>
...
BlockProductsThreeSquare.propTypes = {
  links: PropTypes.array,
  level: PropTypes.number,
  onItemClick: PropTypes.func,
};

BlockProductsThreeSquare.defaultProps = {
  links: [],
  level: 0,
};

export default BlockProductsThreeSquare;
